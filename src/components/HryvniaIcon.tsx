...
/** The ₴ glyph as a path, not a font-rendered character — used in the header
 * logo and mirrored in public/icon.svg for the favicon/PWA icon, so both stay
 * pixel-consistent regardless of what fonts are available. Color via `currentColor`. */
export function HryvniaIcon({ className }: HryvniaIconProps) {
  return (
    <svg viewBox="0 0 325 435" fill="currentColor" className={className} aria-hidden="true">
