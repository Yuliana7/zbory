...
export const PALETTES: Palette[] = [
  ...
  },
  {
    ...
    accent: '#e5e5e5',
    accentGradient: 'linear-gradient(135deg, #ffffff 0%, #d4d4d4 100%)',
    logoGradient: 'linear-gradient(135deg, #525252, #a3a3a3)',
    cardBg: 'rgba(255,255,255,0.05)',
    cardBorder: 'rgba(255,255,255,0.12)',
    progressTrack: 'rgba(255,255,255,0.1)',
    chartLine: '#d4d4d4',
    chartArea: 'rgba(212,212,212,0.2)',
  ...
  },
  {
    ...
    accent: '#171717',
    accentGradient: 'linear-gradient(135deg, #0a0a0a 0%, #404040 100%)',
    logoGradient: 'linear-gradient(135deg, #171717, #525252)',
